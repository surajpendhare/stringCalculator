...
//String with multuple Numbers
console.assert(add("1,2,3") === 6, 'Test failed: add("1,2,3") should return 6');
console.assert(
  add("5,10,15,20, 25, 30") === 110,
  'Test failed: add("10,20,30,40") should return 105'
);
...
try {
  ...
  console.assert(
    ...
    "Test failed: Negative number check"
  );
}
...
try {
  ...
  console.assert(
    error.message === "Negative numbers not allowed: -2, -3",
    "Test failed: Multiple negative number check"
  );
}
